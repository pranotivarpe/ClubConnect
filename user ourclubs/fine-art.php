...
<head>
  ...
  />
  <link rel="icon" href="../images/clubconect-logo.png" />
    <title>Fine Art club</title>
</head>
<body>
                ...
                <div class="flex justify-between items-center text-gray-700">
                    ...
                    <ul class="hidden md:flex items-center text-[18px] font-semibold pr-10">
                        ...
                        <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1"><a href="../dashboard/dashboard.php">
                                dashboard</a></li>
                        <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1"><a href="../home/clubs.php">Clubs</a></li>
                        <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1"><a
                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24">Fine Art club</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <img src="../images/fineart.png" alt=".../"
                                                                            class="rounded-full" />
                                                                    </div>
                                                                    <div class="flex flex-col w-full md:w-3/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">The Fine Art Club is a creative space where members explore various forms of visual arts such as painting, sculpture, and digital art. It fosters artistic expression, skill development, and a deeper appreciation for the visual arts in a collaborative environment The Fine Art Club is dedicated to fostering creativity and nurturing artistic talent through a variety of mediums such as painting, drawing, sculpture, and photography. It encourages both beginners and experienced artists to express themselves, collaborate on projects, and showcase their work through exhibitions and workshops. Members can develop their skills, learn new techniques, and be part of a community that celebrates artistic growth..</div>
...
$sql ="Select * from `clubinfo`where `club_name` = 'Fine-art Club'";
...
?>
    ...
    <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24 decoration-8">
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'Fine-art Club'";
...
$sql   ="Select * from `members` where `club_name` = 'Fine-art Club'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
