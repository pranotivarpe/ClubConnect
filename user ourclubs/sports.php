                                                            ...
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div class="flex flex-col w-full md:w-2/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">The Sports Club fosters physical fitness, teamwork, and sportsmanship among students. It organizes various inter and intra-college competitions, providing a platform for athletes to showcase their talents. </div>
