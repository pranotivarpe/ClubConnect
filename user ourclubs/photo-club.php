                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24">Photography Club</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <img src="../images/photoclub.jpg" alt=".../"
                                                                            class="rounded-full" />
                                                                    </div>
                                                                    <div class="flex flex-col w-full md:w-3/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">The Photography Club is a creative hub where photography enthusiasts of all skill levels come together to explore and improve their craft. Members engage in hands-on workshops, photo walks, and competitions to sharpen their technical and artistic skills. The club provides a supportive environment to experiment with different styles, including portrait, landscape, and macro photography. With opportunities to showcase their work, members can receive valuable feedback and inspire each other to capture the world in unique ways.</div>
...
$sql ="Select * from `clubinfo` where `club_name` = 'Photography Club'";
...
?>
    ...
    <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24 decoration-8">
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'Photography Club'";
...
$sql   ="Select * from `members` where `club_name` = 'Photography Club'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
