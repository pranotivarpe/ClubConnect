        ...
        <div class="flex flex-col justify-center items-center bg-slate-100 max-w-7xl">
            ...
            <div class="flex flex-col items-center justify-evenly my-12 lg:px-10 lg:flex-row space-y-8 lg:space-y-0">
                ...
                <div
                    ...
                    <p class="text-black mt-3 text-center w-[90%] lg:w-[100%]"> One of the main goals of the MIT is to prepare the students for professional world, including academics and corporate. “READERS CLUB” is another endeavor of AIET, aimed at providing a platform for students to enhance the general & technical knowledge.</p>
            ...
            <div class="flex flex-col items-center justify-evenly my-12 lg:px-10 lg:flex-row space-y-8 lg:space-y-0 ">
                ...
                <div
                    ...
                    <p class="text-black mt-3 text-center w-[90%] lg:w-[100%]"> The WEP Cell of MIT WPU has been formed with the following objectives
