  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap -m-4 ">
      <div class="p-4 md:w-3/4 md:h-1/3  animate__animated animate__bounceIn">
        ...
        <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="../images/ride.jpg" alt="blog">
          <div class="p-6">
            <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">RIDE</h2>
            <h1 class="title-font text-lg font-medium text-gray-900 mb-3">Department of CS</h1>
            <p class="leading-relaxed mb-3">Department of CS Ride notice</p>
            <div class="flex items-center flex-wrap ">
              <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0" href="../notices pdf/ride.pdf">Know More
      ...
      <div class="p-4 md:w-3/4 md:h-1/3  animate__animated animate__bounceIn">
        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="../images/sports.jpg" alt="blog">
          <div class="p-6">
            <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">SPORTS</h2>
            <h1 class="title-font text-lg font-medium text-gray-900 mb-3">Department of CS</h1>
            <p class="leading-relaxed mb-3">Department of CS Sports notice</p>
            <div class="flex items-center flex-wrap">
              <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0" href="../notices pdf/sports.pdf">Know More
                <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M5 12h14"></path>
                  <path d="M12 5l7 7-7 7"></path>
                </svg>
      ...
      <div class="p-4 md:w-3/4 md:h-1/3  animate__animated animate__bounceIn">
        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
          <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="../images/Tsukiakari.webp" alt="blog">
          <div class="p-6">
            <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CLUB</h2>
            <h1 class="title-font text-lg font-medium text-gray-900 mb-3">Department of CS</h1>
            <p class="leading-relaxed mb-3">Department of CS is Organizing a Tsukiakari Japanese Learning Club</p>
            <div class="flex items-center flex-wrap ">
              <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0" href="../notices pdf/Tsukiakari.pdf">Know More
                <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M5 12h14"></path>
                  <path d="M12 5l7 7-7 7"></path>
                </svg>
