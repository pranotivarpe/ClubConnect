                ...
                <div class="flex justify-between items-center text-gray-700">
                    ...
                    <ul class="hidden md:flex items-center text-[18px] font-semibold pr-10">
                        ...
                        <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1"><a href="../dashboard/dashboard.php">
                                dashboard</a></li>
                        <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1"><a href="../home/clubs.php">
                                Clubs</a></li>
                        <li class="text-stone-600 hover:text-blue-600 hover:font-bold font-medium mx-4 my-1"><a
                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24">Life Skill Club</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <img src="../images/lifeskill.jpg" alt=".../"
                                                                            class="rounded-full" />
                                                                    </div>
                                                                    <div class="flex flex-col w-full md:w-3/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">The Life Skills Club focuses on nurturing essential skills for personal and professional development. Members engage in workshops and activities that build resilience, critical thinking, and emotional intelligence. The club offers training in areas like time management, stress management, and effective communication. Through interactive sessions and real-world scenarios, members learn practical skills to navigate everyday challenges confidently. It’s a supportive environment where students grow into well-rounded individuals, ready for success in all aspects of life.</div>
...
$sql ="Select * from `clubinfo` where `club_name` = 'Life Skill Club'";
...
?>
    ...
    <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24 decoration-8">
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'Life Skill Club'";
...
$sql   ="Select * from `members` where `club_name` = 'Life Skill Club'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
