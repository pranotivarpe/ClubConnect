                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24">Women Empowerment Cell </div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <img src="../images/women-cell.jpg" alt=".../"
                                                                            class="rounded-full" />
                                                                    </div>
                                                                    <div class="flex flex-col w-full md:w-3/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">The Women Cell Club is dedicated to empowering and supporting women by fostering awareness about gender equality and women's rights. It organizes seminars, workshops, and events focusing on self-defense, leadership, and career development.</div>
...
$sql ="Select * from `clubinfo` where `club_name` = 'Women empowerment cell'";
...
?>
    ...
    <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24 decoration-8">
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'Women empowerment cell'";
...
$sql   ="Select * from `members` where `club_name` = 'Women empowerment cell'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
