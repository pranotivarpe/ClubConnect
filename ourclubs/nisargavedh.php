                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24"> “Nisargavedh” – The Nature Club</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div class="flex flex-col w-full md:w-3/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">“Nisargavedh” is a nature and environmental club of MIT World Peace University which offers wide spectrum of environmental and nature activities and platform to enhance, exhibit the relationship with Mother Nature.
The club conducts various learning and adventurous activities for students of MIT World Peace University which attempts for the overall development of students.</div>
...
$sql ="Select * from `clubinfo` where `club_name` = 'Nisargavedh Club'";
...
?>
    ...
    <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24 decoration-8">
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'Nisargavedh Club'";
...
$sql   ="Select * from `members` where `club_name` = 'Nisargavedh Club'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
