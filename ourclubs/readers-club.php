                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24">Readers Club</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <img src="../images/readers.jpg" alt=".../"
                                                                            class="rounded-full" />
                                                                    </div>
                                                                    <div class="flex flex-col w-full md:w-3/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">The Reader Club is a community that brings together book lovers, providing a space to discuss literature, share reading recommendations, and engage in intellectual conversations. It fosters a love for reading, helping members explore diverse genres, improve their reading habits, and broaden their knowledge through regular meetups and book-related activities.he Reader Club is an inclusive space where individuals passionate about books can engage in thoughtful discussions, share insights, and explore different literary genres.</div>
...
$sql ="Select * from `clubinfo` where `club_name` = 'Readers Club'";
...
?>
    ...
    <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24 decoration-8">
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'Readers Club'";
...
$sql   ="Select * from `members` where `club_name` = 'Readers Club'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
