                                                    ...
                                                    <div class="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white  ">
                                                        ...
                                                        <div class="flex flex-col md:flex-row items-center justify-center md:w-3/4  ">
                                                            <div class=" flex flex-col items-center justify-center flex py-2">
                                                                <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24">Language Club</div>
                                                                ...
                                                                <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                                                                    ...
                                                                    <div class="flex flex-col w-full md:w-3/3  mx-10">
                                                                        <div class="text-stone-600 font-normal m-2 italic">The Language Club is a vibrant space for students passionate about languages, communication, and cultural exchange. It offers interactive sessions for learning new languages and improving fluency through practice and conversation. Members participate in fun activities like language games, debates, and cultural workshops, fostering a deep appreciation for global diversity. The club encourages peer learning and hosts events such as international film screenings or multilingual storytelling. It’s a welcoming environment where members build confidence, connect with different cultures, and develop valuable language skills.</div>
...
$sql ="Select * from `clubinfo` where `club_name` = 'Language Club'";
...
?>
    ...
    <div class="text-3xl font-bold text-stone-700 text-center md:-ml-24 decoration-8">
        <?php
        $p = "select count(*) as `count` from `members` where `club_name` = 'Language Club'";
...
$sql   ="Select * from `members` where `club_name` = 'Language Club'";
$result = mysqli_query($conn,$sql);
if($result){
    while($row=mysqli_fetch_assoc($result)){
          $id = $row['id'];
